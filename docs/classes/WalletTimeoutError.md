[@demox-labs/leo-wallet-adapter](../README.md) / [Exports](../modules.md) / WalletTimeoutError
...
[src/base/errors.ts:68](https://github.com/demox-labs/leo-wallet-adapter/blob/60deb2b/src/base/errors.ts#L68)
